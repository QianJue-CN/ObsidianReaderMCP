...
class ObsidianMCPServer:
    ...
    async def _handle_update_note(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        if tags is not None or frontmatter is not None:
            ...
            metadata = NoteMetadata(
                ...
                frontmatter=frontmatter if frontmatter is not None else current_metadata.frontmatter,
            )
    ...
    async def _handle_search_notes(self, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    async def _handle_get_vault_info(self, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    async def _handle_get_notes_by_tag(self, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    async def run(self) -> None:
        """Run the MCP server."""
        logger.info(f"Starting {self.mcp_config.server_name} v{self.mcp_config.version}")
